...
const _edit = computed({
  ...
  set: (value: boolean) => {
    if (typeof props.edit === 'boolean') {
      console.warn("Cannot set value of boolean prop")
      // @ts-ignore
      props.edit = value
      return
    }
    props.edit.value = value
  }
})
  ...
  <div class="canvas-container">
    <div class="canvas-head">
      <Transition mode="out-in">
        <div class="icon edit" v-if="!_edit">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" @click="_edit = true">
            <path
        ...
        <div class="icon edit" v-else>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" @click="_edit = false">
            <path
