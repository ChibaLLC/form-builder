...
onMounted(() => {
  if (window.innerWidth < 768) {
    alert(
      "This page is not optimized for mobile devices. Please use a desktop or a tablet to build a form.value."
    );
  }
...
<template>
  <div class="three" :style="styles">
    ...
    <div>
      <FormBuilderProperties :styles="styles" :active="active" :form="form" />
    </div>
  </div>
</template>
<style scoped>
