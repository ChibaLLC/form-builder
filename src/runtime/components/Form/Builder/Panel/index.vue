    ...
    <ul class="panel-items">
      <li>
        <FormBuilderPanelPicker
          @dragstart="emit('dragstart', Field.EMAIL)"
          @dblclick="emit('dblclick', Field.EMAIL)"
        >
          <template #icon>
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <FormBuilderPanelPicker
          @dragstart="emit('dragstart', Field.TEXT)"
          @dblclick="emit('dblclick', Field.TEXT)"
        >
          <template #icon>
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <FormBuilderPanelPicker
          @dragstart="emit('dragstart', Field.CHECKBOX)"
      ...
      <li>
        <FormBuilderPanelPicker @dragstart="emit('dragstart', Field.NUMBER)">
          <template #icon>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
          ...
          <template #description>
            <p>A field for adding a number field.</p>
          </template>
        </FormBuilderPanelPicker>
      </li>
    </ul>
