...
<template>
  <div class="panel" :style="styles">
    ...
    <ul class="panel-items">
      <li>
        <FormBuilderPanelPicker @dragstart="emit('dragstart', Field.EMAIL)" @dblclick="emit('dblclick', Field.EMAIL)">
          <template #icon>
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 14"
              style="width: 15px; height: 15px;" id="Sign-At--Streamline-Flex">
      ...
      <li>
        <FormBuilderPanelPicker @dragstart="emit('dragstart', Field.TEXT)" @dblclick="emit('dblclick', Field.TEXT)">
          <template #icon>
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 14"
              style="width: 15px; height: 15px;" id="Small-Caps--Streamline-Flex">
              <g id="small-caps">
                <path id="Union" fill="currentColor" fill-rule="evenodd"
      ...
      <li>
        <FormBuilderPanelPicker @dragstart="emit('dragstart', Field.CHECKBOX)"
          @dblclick="emit('dragstart', Field.CHECKBOX)">
          <template #icon>
