...
const activePageIndex =
  inject<Ref<string | number | undefined>>(activePageIndexKey);
...
const emits = defineEmits<{
  ...
  deleteField: [pageIndex: string | number, field: FormElementData];
  addField: [pageIndex: string | number, field: FormElementData];
  updateField: [pageIndex: string | number, field: FormElementData];
  deleteCanvas: [string | number];
    ...
    >
      ...
      >
        ...
        <svg
          ...
          y="0px"
          viewBox="0 0 24 30"
          style="enable-background: new 0 0 24 24; width: 100px"
          xml:space="preserve"
        >
          <g>
            <g>
        ...
        <h1 style="width: fit-content; font-size: large">
